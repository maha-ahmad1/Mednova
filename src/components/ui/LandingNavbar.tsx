                  ...
                  <li key={link.id}>
                    {link.dropdown ? (
                      <DropdownMenu>
                        <DropdownMenuTrigger
                          asChild
                          className="mx-2 hover:text-primary  hover:border-b-2 hover:border-b-primary  mt-1  flex items-center gap-0.5 "
                        >
                      ...
                      <Link
                        href={link.link}
                        className=" mx-2   hover:border-b-2 hover:border-b-primary hover:text-primary mt-1 flex items-center"
                      >
                        {link.title}
                      </Link>
                    )}
...
}
{
  /* 
        ...
        <a
                      href={link.link}
                      className=" mx-4 text-base  hover:border-b-2 hover:border-b-primary hover:text-primary py-1 flex"
                    >
                      {link.title}
                      {link.dropdown && (
                        <DropdownMenu>
...
}
{
  /* {isOpen && (
        <div className="md:hidden bg-white shadow-md">
          <button className="block w-full text-left px-4 py-2 text-[var(--primary)] hover:bg-[var(--muted)]">
            تسجيل دخول
          </button>
          <button className="block w-full text-left px-4 py-2 bg-[var(--primary)] text-white hover:brightness-90">
            إنشاء حساب
          </button>
        </div>
      )} */
