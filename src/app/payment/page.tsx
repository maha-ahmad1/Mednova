...
// import LightIcon from "/images/Light22.svg";
...
export default function PaymentPage() {
  ...
  const consultantTypeText =
    currentConsultation.consultantType === "therapist"
      ? "معالج نفسي"
      : "مركز تأهيلي";
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-1">
                        ...
                        <span className="text-sm text-gray-600 flex items-center gap-1">
                          ...
                          <span className="text-yellow-500">★</span> 4.9 (120
                          تقييم)
                        </span>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            يمكنك إضافة كود الخصم قبل الدفع
                          </p>
                        </div>
                      </div>
                      <Button
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      اختر الطريقة المناسبة لإكمال عملية الدفع
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    جميع عمليات الدفع مشفرة باستخدام تقنية TLS 1.3 المتقدمة. نحن
                    لا نخزن أي بيانات بطاقة ائتمانية على خوادمنا.
                  </p>
                      ...
                      <div className="flex items-start gap-3 p-3 bg-green-50 rounded-xl border border-green-100">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600">
                            استرجع المبلغ كاملًا إذا لم تبدأ الاستشارة خلال 24
                            ساعة
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="bg-gray-50 border-t border-gray-200 p-6">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        <a
                          href="#"
                          className="text-[#32A88D] hover:underline font-medium"
                        >
                          تواصل مع الدعم
                        </a>
                      </p>
