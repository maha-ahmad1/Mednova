      ...
      <div className="bg-white w-80 h-full rtl:right-0 ltr:left-0 shadow-2xl relative">
        ...
        <nav className="flex flex-col gap-1 p-4 h-[calc(100%-140px)] overflow-y-auto">
          {variant === "landing" ? (
            ...
            // روابط لوحة التحكم (إذا لزم الأمر)
            <>
              <Link href="/dashboard" className="flex items-center p-4 text-gray-700 hover:text-[#32A88D] hover:bg-[#32A88D]/10 rounded-xl" onClick={onClose}>
                لوحة التحكم
              </Link>
              <Link href="/appointments" className="flex items-center p-4 text-gray-700 hover:text-[#32A88D] hover:bg-[#32A88D]/10 rounded-xl" onClick={onClose}>
                المواعيد
              </Link>
              <Link href="/patients" className="flex items-center p-4 text-gray-700 hover:text-[#32A88D] hover:bg-[#32A88D]/10 rounded-xl" onClick={onClose}>
                المرضى
              </Link>
            </>
          )}
