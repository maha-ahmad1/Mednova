...
import { ChevronDown, Menu, HelpCircle, User, LogOut, Settings, Bell } from \"lucide-react\";
          ...
          <div className=\"flex items-center gap-2\">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align=\"end\"
                sideOffset={0}
                className=\"text-right w-37 bg-white/80 backdrop-blur-lg border-gray-200/60 rounded-md shadow-md p-1\"
              >
