...
type UseUpdateTherapistOptions = {
  onValidationError?: (errors: Record<string, string>) => void;
};

export const useUpdateTherapist = (opts?: UseUpdateTherapistOptions) => {
  ...
  const mutation = useMutation({
    mutationFn: async (data: TherapistFormValues) => {
      ...
      // return axios.post("/api/therapist/update", formData);
      const res = await axios.post("/api/therapist/update", formData);
      return res.data;
    },
