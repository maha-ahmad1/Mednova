...
// // ✅ Zod Schema
// const rehabilitationcenterSchema = z.object({
...
// type PatientFormData = z.infer<typeof rehabilitationcenterSchema>;

// export function RehabilitationCenterForm() {
//   const [isLoading, setIsLoading] = useState(false);

//   const methods = useForm<PatientFormData>({
//     resolver: zodResolver(rehabilitationcenterSchema),
//     mode: "onChange",
//   });
...
//         <h1 className="text-2xl font-bold"> معلومات المركز التأهيلي</h1>
