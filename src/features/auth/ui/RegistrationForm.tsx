...
type AccountType = "individual" | "professional" | "organization";
      ...
      <Card className="w-full h-full flex flex-col justify-center border-0 shadow-none bg-transparent">
        <CardHeader className="space-y-2 " dir="rtl">
          ...
          <CardDescription className="text-muted-foreground">
            قم بإدخال بياناتك للانضمام الى منصة مدنوفا{" "}
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-3" dir="rtl">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  ...
                  <span className="text-xs font-medium">فردي</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-xs font-medium">محترف</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-xs font-medium">مؤسسة</span>
                </button>
              </div>
            </div>
