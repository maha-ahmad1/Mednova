...
//           {/* أيام العمل - الجزء الثاني */}
//           <div className="mb-4">
//             <label className="block mb-3 font-medium">أيام العمل</label>
...
//               render={({ field, fieldState }) => (
//                 <div>
//                   <label className="block mb-2 font-medium">المنطقة الزمنية</label>
//                   <TimeZoneSelector
...
import { FormSelect } from "@/shared/ui/forms";
import TimeZoneSelector from "@/features/consultationtype/video/ui/components/DateTimeSelector/TimeZoneSelector";
import { therapistStep4Schema } from "@/features/profile/_create/validation/registrationSchemas";
import { z } from "zod";

type Step4Data = z.infer<typeof therapistStep4Schema>;
...
export function TherapistFormStep4({
  ...
  const methods = useForm<Step4Data>({
    resolver: zodResolver(therapistStep4Schema),
    mode: "onChange",
    defaultValues: {
      day_of_week: formData.day_of_week || [],
      start_time_morning: formData.start_time_morning || "",
