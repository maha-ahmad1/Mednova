  ...
  return (
    <footer className="relative bg-gradient-to-br from-[#32A88D]/10 via-white to-blue-50/30 border-t border-gray-200 mt-auto overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8" dir="rtl">
          {/* Brand */}
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed max-w-md">
              منصة متكاملة لإدارة الرعاية الصحية والتأهيل الطبي، نقدم خدمات علاجية متطورة 
              تجمع بين الخبرة الطبية والتكنولوجيا الحديثة لرحلة تعافٍ أفضل.
            </p>
            ...
            <div className="space-y-3 mt-6">
              ...
              <div className="flex items-center gap-3 text-gray-600">
                ...
                <span className="text-sm">info@mednova.com</span>
              </div>
              <div className="flex items-center gap-3 text-gray-600">
          ...
          <div className="lg:col-span-1">
            <h3 className="font-bold text-gray-800 mb-4 text-lg">روابط سريعة</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  الرئيسية
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  من نحن
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  الخدمات
                </Link>
              </li>
              <li>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/help" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  مركز المساعدة
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  اتصل بنا
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  الأسئلة الشائعة
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  الدعم الفني
                </Link>
              </li>
            </ul>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/terms" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  الشروط والأحكام
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  سياسة الخصوصية
                </Link>
              </li>
              <li>
                <Link href="/cookies" className="text-gray-600 hover:text-[#32A88D] transition-all duration-200 hover:pr-2 block">
                  سياسة الكوكيز
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              © 2025 ميدنوفا. جميع الحقوق محفوظة.
            </p>
