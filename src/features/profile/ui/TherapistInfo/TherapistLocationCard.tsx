...
export function TherapistLocationCard({ details, userId, refetch ,serverErrors }: TherapistLocationCardProps) {
        ...
        {!editing ? (
          ...
          <>
            ...
            <FormSelect
              ...
              options={(selectedCountry?.cities || []).map((c) => ({ value: c, label: c }))}
              rtl
            />
              ...
              {days.map((d) => (
                <label
                  ...
                  className={`px-4 py-2 border rounded-lg cursor-pointer ${
                    values.day_of_week.includes(d.key) ? "bg-[#32A88D] text-white" : "bg-gray-100"
                  }`}
                >
                  <input
                    type="checkbox"
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setValues((v) => ({ ...v, is_have_evening_time: e.target.checked ? 1 : 0 }))
                }
            ...
            {values.is_have_evening_time === 1 && (
              <>
                <FormInput
                  ...
                  onChange={(e) => setValues((v) => ({ ...v, start_time_evening: e.target.value }))}
                  rtl
                />
                <FormInput
                  ...
                  onChange={(e) => setValues((v) => ({ ...v, end_time_evening: e.target.value }))}
                  rtl
                />
              </>
            )}
