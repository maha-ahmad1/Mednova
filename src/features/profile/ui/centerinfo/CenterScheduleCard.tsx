...
export function CenterScheduleCard({ details, userId, refetch, serverErrors }: CenterScheduleCardProps) {
  ...
  return (
    <Card>
      <CardHeader className="flex justify-between items-center">
        <CardTitle>دوام العمل</CardTitle>
        {!editing ? (
        ...
        {!editing ? (
          ...
          <>
            ...
            <FormInput
              ...
              rtl
              error={serverErrors?.start_time_morning}
            />
            <FormInput
              ...
              rtl
              error={serverErrors?.end_time_morning}
            />
            ...
            {values.is_have_evening_time === 1 && (
              <>
                <FormInput
                  ...
                  rtl
                  error={serverErrors?.start_time_evening}
                />
                <FormInput
                  ...
                  rtl
                  error={serverErrors?.end_time_evening}
                />
              </>
            )}
          </>
