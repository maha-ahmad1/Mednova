...
export default function SmartGlovePage() {
  ...
  const faqItems = [
    {
      ...
      answer: "جهاز تأهيلي متطور يعمل على إعادة تأهيل حركة اليد للمرضى الذين يعانون من ضعف أو شلل في اليد بسبب الجلطات الدماغية، الشلل النصفي، ضمور العضلات، أو كبار السن."
    },
    {
      question: "هل يمكن استخدام القفاز في المنزل؟",
      answer: "نعم، تم تصميم القفاز خصيصاً للاستخدام المنزلي مع إمكانية المتابعة عن بعد من خلال منصة مدنوفا الرقمية."
    },
    {
      question: "كيف يتم تخصيص برنامج العلاج؟",
      answer: "يتم ضبط البرامج التأهيلية من قبل المختص عبر المنصة الرقمية، حيث يمكن تحديد زوايا الحركة، قوة التمرين، ومدة الجلسات حسب حالة كل مريض."
    },
    {
      question: "ما مدى فعالية القفاز؟",
      answer: "أظهرت الدراسات تحسناً ملحوظاً في حركة اليد عند الاستخدام المنتظم، حيث يتم تتبع التقدم بشكل لحظي وتحليل النتائج باستخدام الذكاء الاصطناعي."
    },
    {
      question: "هل القفاز مناسب للأطفال؟",
      answer: "نعم، القفاز مصمم بمقاسات مختلفة تناسب جميع الأعمار، مع برامج علاجية مخصصة للأطفال."
    }
  ];
  ...
  const stats = [
    ...
    { value: "+500", label: "مريض تم تأهيلهم", icon: <Users className="w-5 h-5" /> },
    { value: "+85%", label: "تحسن في الحركة", icon: <TrendingUp className="w-5 h-5" /> },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-right order-2 lg:order-1">
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  جهاز تأهيلي متقدم مصمم لإعادة تأهيل حركة اليد بطريقة عملية، ذكية، وقابلة للتخصيص. 
                  يستهدف مرضى الجلطات الدماغية، الشلل النصفي، ضمور العضلات، كبار السن، والأطفال، 
                  سواء داخل المراكز أو من المنزل.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  <Button variant="outline" className="border-2 border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-xl px-8 py-6 text-lg font-medium transition-all duration-300">
              ...
              <div className="relative order-1 lg:order-2">
                ...
                {/* Floating Elements */}
                <div className="absolute -top-4 -right-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white p-4 rounded-2xl shadow-xl">
                  <div className="text-center">
                    <div className="text-2xl font-bold">40%</div>
                    <div className="text-sm">تحسن في<br />الحركة</div>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 -left-4 bg-white p-4 rounded-2xl shadow-xl border border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-gray-800">دقة عالية</div>
                      <div className="text-xs text-gray-500">في كل إصبع</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-gray-50/50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-4">كيف يعمل القفاز الذكي؟</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                نظام متكامل يجمع بين الأجهزة الذكية والمنصة الرقمية للعلاج التأهيلي
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-right">
                ...
                <p className="text-lg text-gray-600 mb-8">
                  نظام متكامل يربط القفاز الذكي بالمريض والمعالج، يوفر تحليلات ذكية وتقارير مفصلة
                </p>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="font-bold text-gray-800">لوحة تحكم المريض</h3>
                      <Badge className="bg-emerald-100 text-emerald-700">نشط</Badge>
                    </div>
                    <div className="space-y-4">
                      {[
                        { label: "تقدم العلاج الأسبوعي", value: "75%", width: "75%", color: "from-emerald-500 to-teal-500" },
                        { label: "قوة القبضة", value: "+40%", width: "60%", color: "from-blue-500 to-cyan-500" },
                        { label: "مرونة الأصابع", value: "+65%", width: "65%", color: "from-purple-500 to-pink-500" }
                      ].map((item, index) => (
                        <div key={index}>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { value: "12", label: "جلسات مكتملة", color: "text-emerald-600" },
                      { value: "24", label: "ساعة علاج", color: "text-blue-600" },
                      { value: "85%", label: "رضا العملاء", color: "text-purple-600" }
                    ].map((stat, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg p-3 text-center hover:bg-gray-100 transition">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-4">فوائد القفاز الذكي</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {benefits.map((benefit, index) => (
                <Card key={index} className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-b ${benefit.color}`}>
                ...
                {faqItems.map((item, index) => (
                  ...
                  >
                    <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-gray-50/50 text-right">
                      <span className="font-semibold text-gray-800 flex-1">{item.question}</span>
                    </AccordionTrigger>
